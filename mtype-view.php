                ...
                <div class="card-body">
                   <form action="code.php" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="mem_type_name" class="form-control" value="<?=$membership_type['mem_type_name'];?>" readonly>
                    ...
                    <div class="from-group">
                        ...
                        <a class="btn btn-danger" href="mtype-index.php" >Go Back</a>
